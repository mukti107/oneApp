						...
						<div class="card theme">
						  ...
						  <div class="card-content">
						    <div class="card-content-inner">
					    		<div class="row">
							        <div class="col-33 text-center">Max Price <br/> Rs. {{max_price}}</div>
							        <div class="col-33">Min Price  <br/> Rs. {{min_price}}</div>
							        <div class="col-33">Closing Price  <br/> Rs. {{closing_price}}</div>
							    </div>
						    </div>
						  </div>
