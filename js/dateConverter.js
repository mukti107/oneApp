	...
	function getNepaliDateInfo(date){
        return {dayName:get_day_of_week_nep(date.num_day),date:num_to_nepali(date.date),monthName:get_nepali_month(date.month),year:num_to_nepali(date.year)};
    }

    function getEnglishDateInfo(date){
        return {dayName:get_day_of_week_eng(date.num_day),date:date.date,monthName:get_english_month(date.month),year:date.year};
    }